...
const PROJECTS: ProjectData[] = [
  ...
  { title: 'Non-Euclidean', color: '#8b5cf6', description: 'Non-euclidean-esque world where space is not what it seems', url: 'https://github.com/FrankWan27/non-euclidean-esque', image: 'projects/noneuclid.png', video: 'projects/noneuclid.mp4' },
  ...
  { title: 'Boids', color: '#f4a261', description: 'Multiplayer boids simulator', url: 'https://github.com/FrankWan27/Boids', image: 'projects/boids.png', video: 'projects/boids.mp4' },
  { title: 'Agar.AI', color: '#2a9d8f', description: 'AI that learns to play Agar.io using NEAT', url: 'https://github.com/FrankWan27/Agar.AI', image: 'projects/agar.png', video: 'projects/agar.mp4' },
  { title: 'Pathfinding Vis', color: '#6fc3df', description: '3D pathfinding visualizer built in Unity', url: 'https://github.com/FrankWan27/PathfindingVis', image: 'projects/pathfinding.jpg', video: 'projects/pathfinding.mp4' },
  { title: 'Blitz Minesweeper', color: '#e63946', description: 'Fast-paced multiplayer minesweeper', url: 'https://github.com/FrankWan27/Blitz-Minesweeper', image: 'projects/minesweeper.png', video: 'projects/minesweeper.mp4' },
  ...
  { title: 'Pacman', color: '#8b5cf6', description: 'Pacman-like game built for Android', url: 'https://github.com/FrankWan27/PacmanPrototype', image: 'projects/pacman.png', video: 'projects/pacman.mp4' },
  ...
  { title: 'Rotato Potato', color: '#e9c46a', description: '2D puzzle platformer using rotation, built with PixiJS', url: 'https://github.com/FrankWan27/rotato-potato', image: 'projects/rotato.jpg', video: 'projects/rotato.mp4' },
